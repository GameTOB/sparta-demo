...
.controller('framework.user.loginCtrl', 
	["$scope", "$location", "$timeout", "User", "ApiErrno", "Debug", function ($scope , $location , $timeout , User , ApiErrno , Debug) {
	//由于可能误进此场景，所以先进行判定
...
.controller('framework.user.logoutCtrl', ["$location", "User", function ($location , User ) {
