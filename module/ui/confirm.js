...
.controller('module.ui.confirmCtrl', ["$scope", "$modalInstance", "data", function ($scope , $modalInstance , data) {
	$scope.data = data;
...
.factory('UIConfirm', ["$rootScope", "$q", "$location", "$sce", "$modal", "$modalStack", "$document", function($rootScope, $q, $location, $sce, $modal, $modalStack, $document) {
