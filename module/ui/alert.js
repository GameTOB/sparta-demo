...
.controller('module.ui.alertCtrl', ["$scope", "$modalInstance", "data", function ($scope , $modalInstance , data) {
	$scope.data = data;
...
.factory('UIAlert', ["$rootScope", "$q", "$location", "$sce", "$modal", "$modalStack", "$document", function($rootScope, $q, $location, $sce, $modal, $modalStack, $document) {
