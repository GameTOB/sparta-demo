...
.controller("app.form.uploadCtrl", ["$rootScope", "$scope", "$timeout", "$q", "UIAlert", "ExampleData", function($rootScope , $scope, $timeout, $q , UIAlert , ExampleData) {
...
.controller("app.form.uploadAvatarCtrl", ["$rootScope", "$scope", "$timeout", "$q", "UIAlert", "ExampleData", function($rootScope , $scope, $timeout, $q , UIAlert , ExampleData) {
...
.controller("app.form.uploadPhotosCtrl", ["$rootScope", "$scope", "$timeout", "$q", "$filter", "UIAlert", "ExampleData", function($rootScope , $scope, $timeout, $q , $filter , UIAlert , ExampleData) {
	$scope.photos = [];
	$scope.errorMessage = "";
	$scope.uploaderOptions = {
