...
.controller("app.form.uploadCtrl", ["$rootScope", "$scope", "$timeout", function($rootScope , $scope, $timeout) {
	//空    
}])


.controller("app.form.uploadAvatarCtrl", ["$rootScope", "$scope", "$timeout", function($rootScope , $scope, $timeout) {
...
.controller("app.form.uploadPhotosCtrl", ["$rootScope", "$scope", "$timeout", "$filter", function($rootScope , $scope, $timeout, $filter) {
	$scope.photos = [];
	$scope.errorMessage = "";
	$scope.uploaderOptions = {
		//限制上传的所有图片大小
