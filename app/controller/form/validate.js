...
.controller("app.form.validateCtrl", ["$scope", "$timeout", "$q", "$anchorScroll", "UIAlert", "FormExample", "ValidatePattern", function($scope, $timeout, $q , $anchorScroll, UIAlert , FormExample , ValidatePattern) {
